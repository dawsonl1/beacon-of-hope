...
namespace backend.Migrations
{
    ...
    [Migration("20260413192315_AddVisitEvents")]
    partial class AddVisitEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.DonorOutreach", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("donor_outreaches_pkey");

                    b.HasIndex("SupporterId", "CreatedAt")
                        .HasDatabaseName("idx_donor_outreaches_supporter");

                    b.ToTable("donor_outreaches", (string)null);
                });
            ...
            modelBuilder.Entity("backend.Models.VisitEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("AsnOrg")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("asn_org");

                    b.Property<string>("BotSignals")
                        .HasColumnType("jsonb")
                        .HasColumnName("bot_signals");

                    b.Property<int?>("CfBotScore")
                        .HasColumnType("integer")
                        .HasColumnName("cf_bot_score");
                    ...
                    b.Property<int>("InteractionMs")
                        .HasColumnType("integer")
                        .HasColumnName("interaction_ms");
                    ...
                    b.Property<int>("ScrollDepthPct")
                        .HasColumnType("integer")
                        .HasColumnName("scroll_depth_pct");
                    ...
                    b.HasKey("Id")
                        .HasName("visit_events_pkey");

                    b.HasIndex("FingerprintHash")
                        .HasDatabaseName("idx_visit_events_fingerprint");

                    b.HasIndex("Timestamp")
                        .HasDatabaseName("idx_visit_events_timestamp");

                    b.HasIndex("Verdict")
                        .HasDatabaseName("idx_visit_events_verdict");

                    b.HasIndex("VisitorId")
                        .HasDatabaseName("idx_visit_events_visitor");
