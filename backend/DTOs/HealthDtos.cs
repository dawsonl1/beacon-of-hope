...
public class HealthRecordRequest
{
    ...
    [Range(0, 100, ErrorMessage = "NutritionScore must be between 0 and 100.")]
    public decimal? NutritionScore { get; set; }
    [Range(0, 100, ErrorMessage = "SleepQualityScore must be between 0 and 100.")]
    public decimal? SleepQualityScore { get; set; }
    [Range(0, 100, ErrorMessage = "EnergyLevelScore must be between 0 and 100.")]
    public decimal? EnergyLevelScore { get; set; }
    [Range(0, 100, ErrorMessage = "GeneralHealthScore must be between 0 and 100.")]
